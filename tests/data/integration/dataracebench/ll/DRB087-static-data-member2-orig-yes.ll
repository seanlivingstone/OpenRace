...
@0 = private unnamed_addr constant [53 x i8] c";DRB087-static-data-member2-orig-yes.cpp;main;72;3;;\00", align 1
...
@.str.1 = private unnamed_addr constant [40 x i8] c"DRB087-static-data-member2-orig-yes.cpp\00", align 1
...
define dso_local i32 @main() #4 !dbg !1004 {
entry:
  %retval = alloca i32, align 4
  store i32 0, i32* %retval, align 4
  call void (%struct.ident_t*, i32, void (i32*, i32*, ...)*, ...) @__kmpc_fork_call(%struct.ident_t* @1, i32 0, void (i32*, i32*, ...)* bitcast (void (i32*, i32*)* @.omp_outlined. to void (i32*, i32*, ...)*)), !dbg !1005
  %0 = load i32, i32* @_ZN1A8pcounterE, align 4, !dbg !1006, !tbaa !1007
...
cond.false:                                       ; preds = %entry
  call void @__assert_fail(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([40 x i8], [40 x i8]* @.str.1, i64 0, i64 0), i32 77, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #13, !dbg !1006
...
cond.end:                                         ; preds = %1, %cond.true
  %2 = load i32, i32* @_ZN1A7counterE, align 4, !dbg !1011, !tbaa !1007
  %call = call nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* @_ZSt4cout, i32 %2), !dbg !1012
  %call1 = call nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* nonnull align 8 dereferenceable(8) %call, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i64 0, i64 0)), !dbg !1013
  %3 = load i32, i32* @_ZN1A8pcounterE, align 4, !dbg !1014, !tbaa !1007
  %call2 = call nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* %call1, i32 %3), !dbg !1015
  %call3 = call nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSolsEPFRSoS_E(%"class.std::basic_ostream"* %call2, %"class.std::basic_ostream"* (%"class.std::basic_ostream"*)* @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_), !dbg !1016
  ret i32 0, !dbg !1017
}

; Function Attrs: norecurse nounwind sspstrong uwtable
define internal void @.omp_outlined._debug__(i32* noalias %.global_tid., i32* noalias %.bound_tid.) #5 !dbg !1018 {
entry:
  %.global_tid..addr = alloca i32*, align 8
  %.bound_tid..addr = alloca i32*, align 8
  store i32* %.global_tid., i32** %.global_tid..addr, align 8, !tbaa !1028
  call void @llvm.dbg.declare(metadata i32** %.global_tid..addr, metadata !1026, metadata !DIExpression()), !dbg !1030
  store i32* %.bound_tid., i32** %.bound_tid..addr, align 8, !tbaa !1028
  call void @llvm.dbg.declare(metadata i32** %.bound_tid..addr, metadata !1027, metadata !DIExpression()), !dbg !1030
  %0 = load i32, i32* @_ZN1A7counterE, align 4, !dbg !1031, !tbaa !1007
  %inc = add nsw i32 %0, 1, !dbg !1031
  store i32 %inc, i32* @_ZN1A7counterE, align 4, !dbg !1031, !tbaa !1007
  %1 = load i32, i32* @_ZN1A8pcounterE, align 4, !dbg !1033, !tbaa !1007
  %inc1 = add nsw i32 %1, 1, !dbg !1033
  store i32 %inc1, i32* @_ZN1A8pcounterE, align 4, !dbg !1033, !tbaa !1007
  ret void, !dbg !1034
}
...
; Function Attrs: norecurse nounwind sspstrong uwtable
define internal void @.omp_outlined.(i32* noalias %.global_tid., i32* noalias %.bound_tid.) #5 !dbg !1035 {
entry:
  %.global_tid..addr = alloca i32*, align 8
  %.bound_tid..addr = alloca i32*, align 8
  store i32* %.global_tid., i32** %.global_tid..addr, align 8, !tbaa !1028
  call void @llvm.dbg.declare(metadata i32** %.global_tid..addr, metadata !1037, metadata !DIExpression()), !dbg !1039
  store i32* %.bound_tid., i32** %.bound_tid..addr, align 8, !tbaa !1028
  call void @llvm.dbg.declare(metadata i32** %.bound_tid..addr, metadata !1038, metadata !DIExpression()), !dbg !1039
  %0 = load i32*, i32** %.global_tid..addr, align 8, !dbg !1040, !tbaa !1028
  %1 = load i32*, i32** %.bound_tid..addr, align 8, !dbg !1040, !tbaa !1028
  call void @.omp_outlined._debug__(i32* %0, i32* %1) #3, !dbg !1040
  ret void, !dbg !1040
}

; Function Attrs: nounwind
declare !callback !1041 void @__kmpc_fork_call(%struct.ident_t*, i32, void (i32*, i32*, ...)*, ...) #3

; Function Attrs: noreturn nounwind
declare void @__assert_fail(i8*, i8*, i32, i8*) #7

; Function Attrs: inlinehint sspstrong uwtable
define available_externally nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* nonnull align 8 dereferenceable(8) %__out, i8* %__s) #8 !dbg !1043 {
entry:
  %__out.addr = alloca %"class.std::basic_ostream"*, align 8
  %__s.addr = alloca i8*, align 8
  store %"class.std::basic_ostream"* %__out, %"class.std::basic_ostream"** %__out.addr, align 8, !tbaa !1028
  call void @llvm.dbg.declare(metadata %"class.std::basic_ostream"** %__out.addr, metadata !1051, metadata !DIExpression()), !dbg !1108
  store i8* %__s, i8** %__s.addr, align 8, !tbaa !1028
  call void @llvm.dbg.declare(metadata i8** %__s.addr, metadata !1052, metadata !DIExpression()), !dbg !1109
  %0 = load i8*, i8** %__s.addr, align 8, !dbg !1110, !tbaa !1028
  %tobool = icmp ne i8* %0, null, !dbg !1110
  br i1 %tobool, label %if.else, label %if.then, !dbg !1112

if.then:                                          ; preds = %entry
  %1 = load %"class.std::basic_ostream"*, %"class.std::basic_ostream"** %__out.addr, align 8, !dbg !1113, !tbaa !1028
  %2 = bitcast %"class.std::basic_ostream"* %1 to i8**, !dbg !1113
  %vtable = load i8*, i8** %2, align 8, !dbg !1113, !tbaa !1114
  %vbase.offset.ptr = getelementptr i8, i8* %vtable, i64 -24, !dbg !1113
  %3 = bitcast i8* %vbase.offset.ptr to i64*, !dbg !1113
  %vbase.offset = load i64, i64* %3, align 8, !dbg !1113
  %4 = bitcast %"class.std::basic_ostream"* %1 to i8*, !dbg !1113
  %add.ptr = getelementptr inbounds i8, i8* %4, i64 %vbase.offset, !dbg !1113
  %5 = bitcast i8* %add.ptr to %"class.std::basic_ios"*, !dbg !1113
  call void @_ZNSt9basic_iosIcSt11char_traitsIcEE8setstateESt12_Ios_Iostate(%"class.std::basic_ios"* %5, i32 1), !dbg !1116
  br label %if.end, !dbg !1113

if.else:                                          ; preds = %entry
  %6 = load %"class.std::basic_ostream"*, %"class.std::basic_ostream"** %__out.addr, align 8, !dbg !1117, !tbaa !1028
  %7 = load i8*, i8** %__s.addr, align 8, !dbg !1118, !tbaa !1028
  %8 = load i8*, i8** %__s.addr, align 8, !dbg !1119, !tbaa !1028
  %call = call i64 @_ZNSt11char_traitsIcE6lengthEPKc(i8* %8), !dbg !1120
  %call1 = call nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(%"class.std::basic_ostream"* nonnull align 8 dereferenceable(8) %6, i8* %7, i64 %call), !dbg !1121
  br label %if.end

if.end:                                           ; preds = %if.else, %if.then
  %9 = load %"class.std::basic_ostream"*, %"class.std::basic_ostream"** %__out.addr, align 8, !dbg !1122, !tbaa !1028
  ret %"class.std::basic_ostream"* %9, !dbg !1123
}

declare nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"*, i32) #1

; Function Attrs: sspstrong uwtable
define available_externally nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSolsEPFRSoS_E(%"class.std::basic_ostream"* %this, %"class.std::basic_ostream"* (%"class.std::basic_ostream"*)* %__pf) #0 align 2 !dbg !1124 {
entry:
  %this.addr = alloca %"class.std::basic_ostream"*, align 8
  %__pf.addr = alloca %"class.std::basic_ostream"* (%"class.std::basic_ostream"*)*, align 8
  store %"class.std::basic_ostream"* %this, %"class.std::basic_ostream"** %this.addr, align 8, !tbaa !1028
  call void @llvm.dbg.declare(metadata %"class.std::basic_ostream"** %this.addr, metadata !1135, metadata !DIExpression()), !dbg !1138
  store %"class.std::basic_ostream"* (%"class.std::basic_ostream"*)* %__pf, %"class.std::basic_ostream"* (%"class.std::basic_ostream"*)** %__pf.addr, align 8, !tbaa !1028
  call void @llvm.dbg.declare(metadata %"class.std::basic_ostream"* (%"class.std::basic_ostream"*)** %__pf.addr, metadata !1137, metadata !DIExpression()), !dbg !1139
  %this1 = load %"class.std::basic_ostream"*, %"class.std::basic_ostream"** %this.addr, align 8
  %0 = load %"class.std::basic_ostream"* (%"class.std::basic_ostream"*)*, %"class.std::basic_ostream"* (%"class.std::basic_ostream"*)** %__pf.addr, align 8, !dbg !1140, !tbaa !1028
  %call = call nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* %0(%"class.std::basic_ostream"* nonnull align 8 dereferenceable(8) %this1), !dbg !1140
  ret %"class.std::basic_ostream"* %call, !dbg !1141
}

; Function Attrs: inlinehint sspstrong uwtable
define available_externally nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_(%"class.std::basic_ostream"* nonnull align 8 dereferenceable(8) %__os) #8 !dbg !1142 {
entry:
  %__os.addr = alloca %"class.std::basic_ostream"*, align 8
  store %"class.std::basic_ostream"* %__os, %"class.std::basic_ostream"** %__os.addr, align 8, !tbaa !1028
  call void @llvm.dbg.declare(metadata %"class.std::basic_ostream"** %__os.addr, metadata !1146, metadata !DIExpression()), !dbg !1148
  %0 = load %"class.std::basic_ostream"*, %"class.std::basic_ostream"** %__os.addr, align 8, !dbg !1149, !tbaa !1028
  %1 = load %"class.std::basic_ostream"*, %"class.std::basic_ostream"** %__os.addr, align 8, !dbg !1150, !tbaa !1028
  %2 = bitcast %"class.std::basic_ostream"* %1 to i8**, !dbg !1150
  %vtable = load i8*, i8** %2, align 8, !dbg !1150, !tbaa !1114
  %vbase.offset.ptr = getelementptr i8, i8* %vtable, i64 -24, !dbg !1150
  %3 = bitcast i8* %vbase.offset.ptr to i64*, !dbg !1150
  %vbase.offset = load i64, i64* %3, align 8, !dbg !1150
  %4 = bitcast %"class.std::basic_ostream"* %1 to i8*, !dbg !1150
  %add.ptr = getelementptr inbounds i8, i8* %4, i64 %vbase.offset, !dbg !1150
  %5 = bitcast i8* %add.ptr to %"class.std::basic_ios"*, !dbg !1150
  %call = call signext i8 @_ZNKSt9basic_iosIcSt11char_traitsIcEE5widenEc(%"class.std::basic_ios"* %5, i8 signext 10), !dbg !1151
  %call1 = call nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSo3putEc(%"class.std::basic_ostream"* %0, i8 signext %call), !dbg !1152
  %call2 = call nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZSt5flushIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_(%"class.std::basic_ostream"* nonnull align 8 dereferenceable(8) %call1), !dbg !1153
  ret %"class.std::basic_ostream"* %call2, !dbg !1154
}

; Function Attrs: sspstrong uwtable
define available_externally void @_ZNSt9basic_iosIcSt11char_traitsIcEE8setstateESt12_Ios_Iostate(%"class.std::basic_ios"* %this, i32 %__state) #0 align 2 !dbg !1155 {
entry:
  %this.addr = alloca %"class.std::basic_ios"*, align 8
  %__state.addr = alloca i32, align 4
  store %"class.std::basic_ios"* %this, %"class.std::basic_ios"** %this.addr, align 8, !tbaa !1028
...
define linkonce_odr dso_local i64 @_ZNSt11char_traitsIcE6lengthEPKc(i8* %__s) #9 comdat align 2 !dbg !1177 {
entry:
  %__s.addr = alloca i8*, align 8
  store i8* %__s, i8** %__s.addr, align 8, !tbaa !1028
  call void @llvm.dbg.declare(metadata i8** %__s.addr, metadata !1179, metadata !DIExpression()), !dbg !1180
  %0 = load i8*, i8** %__s.addr, align 8, !dbg !1181, !tbaa !1028
  %call = call i64 @strlen(i8* %0) #3, !dbg !1182
...
define linkonce_odr dso_local i32 @_ZStorSt12_Ios_IostateS_(i32 %__a, i32 %__b) #10 comdat !dbg !1184 {
entry:
...
; Function Attrs: nounwind sspstrong uwtable
define available_externally i32 @_ZNKSt9basic_iosIcSt11char_traitsIcEE7rdstateEv(%"class.std::basic_ios"* %this) #9 align 2 !dbg !1196 {
entry:
  %this.addr = alloca %"class.std::basic_ios"*, align 8
  store %"class.std::basic_ios"* %this, %"class.std::basic_ios"** %this.addr, align 8, !tbaa !1028
...
; Function Attrs: inlinehint sspstrong uwtable
define available_externally nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZSt5flushIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_(%"class.std::basic_ostream"* nonnull align 8 dereferenceable(8) %__os) #8 !dbg !1214 {
entry:
  %__os.addr = alloca %"class.std::basic_ostream"*, align 8
  store %"class.std::basic_ostream"* %__os, %"class.std::basic_ostream"** %__os.addr, align 8, !tbaa !1028
  call void @llvm.dbg.declare(metadata %"class.std::basic_ostream"** %__os.addr, metadata !1216, metadata !DIExpression()), !dbg !1217
  %0 = load %"class.std::basic_ostream"*, %"class.std::basic_ostream"** %__os.addr, align 8, !dbg !1218, !tbaa !1028
  %call = call nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSo5flushEv(%"class.std::basic_ostream"* %0), !dbg !1219
...
; Function Attrs: sspstrong uwtable
define available_externally signext i8 @_ZNKSt9basic_iosIcSt11char_traitsIcEE5widenEc(%"class.std::basic_ios"* %this, i8 signext %__c) #0 align 2 !dbg !1221 {
entry:
  %this.addr = alloca %"class.std::basic_ios"*, align 8
  ...
  %call = call nonnull align 8 dereferenceable(570) %"class.std::ctype"* @_ZSt13__check_facetISt5ctypeIcEERKT_PS3_(%"class.std::ctype"* %0), !dbg !1236
...
; Function Attrs: inlinehint sspstrong uwtable
define linkonce_odr dso_local nonnull align 8 dereferenceable(570) %"class.std::ctype"* @_ZSt13__check_facetISt5ctypeIcEERKT_PS3_(%"class.std::ctype"* %__f) #8 comdat !dbg !1240 {
entry:
  %__f.addr = alloca %"class.std::ctype"*, align 8
  store %"class.std::ctype"* %__f, %"class.std::ctype"** %__f.addr, align 8, !tbaa !1028
  call void @llvm.dbg.declare(metadata %"class.std::ctype"** %__f.addr, metadata !1249, metadata !DIExpression()), !dbg !1252
  %0 = load %"class.std::ctype"*, %"class.std::ctype"** %__f.addr, align 8, !dbg !1253, !tbaa !1028
  %tobool = icmp ne %"class.std::ctype"* %0, null, !dbg !1253
  br i1 %tobool, label %if.end, label %if.then, !dbg !1255

if.then:                                          ; preds = %entry
  call void @_ZSt16__throw_bad_castv() #14, !dbg !1256
  unreachable, !dbg !1256

if.end:                                           ; preds = %entry
  %1 = load %"class.std::ctype"*, %"class.std::ctype"** %__f.addr, align 8, !dbg !1257, !tbaa !1028
  ret %"class.std::ctype"* %1, !dbg !1258
}

; Function Attrs: sspstrong uwtable
define linkonce_odr dso_local signext i8 @_ZNKSt5ctypeIcE5widenEc(%"class.std::ctype"* %this, i8 signext %__c) #0 comdat align 2 !dbg !1259 {
entry:
  %retval = alloca i8, align 1
  %this.addr = alloca %"class.std::ctype"*, align 8
  %__c.addr = alloca i8, align 1
  store %"class.std::ctype"* %this, %"class.std::ctype"** %this.addr, align 8, !tbaa !1028
...
if.end:                                           ; preds = %entry
  ...
  %vtable = load i8 (%"class.std::ctype"*, i8)**, i8 (%"class.std::ctype"*, i8)*** %4, align 8, !dbg !1280, !tbaa !1114
...
; Function Attrs: sspstrong uwtable
define internal void @_GLOBAL__sub_I_DRB087_static_data_member2_orig_yes.cpp() #0 section ".text.startup" !dbg !1283 {
entry:
...
; Function Attrs: sspstrong uwtable
define weak_odr hidden i32* @_ZTWN1A8pcounterE() #12 comdat {
...
attributes #8 = { inlinehint sspstrong uwtable "correctly-rounded-divide-sqrt-fp-math"="false" "disable-tail-calls"="false" "frame-pointer"="none" "less-precise-fpmad"="false" "min-legal-vector-width"="0" "no-infs-fp-math"="false" "no-jump-tables"="false" "no-nans-fp-math"="false" "no-signed-zeros-fp-math"="false" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "unsafe-fp-math"="false" "use-soft-float"="false" }
...
attributes #12 = { sspstrong uwtable "correctly-rounded-divide-sqrt-fp-math"="false" "disable-tail-calls"="false" "frame-pointer"="none" "less-precise-fpmad"="false" "no-infs-fp-math"="false" "no-nans-fp-math"="false" "no-signed-zeros-fp-math"="false" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "unsafe-fp-math"="false" "use-soft-float"="false" }
...
!31 = !DIFile(filename: "DRB087-static-data-member2-orig-yes.cpp", directory: "/home/peiming/Documents/projects/OpenRace/tests/data/integration/dataracebench")
!32 = !{!33}
...
!1004 = distinct !DISubprogram(name: "main", scope: !31, file: !31, line: 70, type: !685, scopeLine: 71, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !30, retainedNodes: !1002)
!1005 = !DILocation(line: 72, column: 3, scope: !1004)
!1006 = !DILocation(line: 77, column: 3, scope: !1004)
!1007 = !{!1008, !1008, i64 0}
!1008 = !{!"int", !1009, i64 0}
!1009 = !{!"omnipotent char", !1010, i64 0}
!1010 = !{!"Simple C++ TBAA"}
!1011 = !DILocation(line: 78, column: 9, scope: !1004)
!1012 = !DILocation(line: 78, column: 7, scope: !1004)
!1013 = !DILocation(line: 78, column: 20, scope: !1004)
!1014 = !DILocation(line: 78, column: 28, scope: !1004)
!1015 = !DILocation(line: 78, column: 25, scope: !1004)
!1016 = !DILocation(line: 78, column: 39, scope: !1004)
!1017 = !DILocation(line: 79, column: 3, scope: !1004)
!1018 = distinct !DISubprogram(name: ".omp_outlined._debug__", scope: !31, file: !31, line: 73, type: !1019, scopeLine: 73, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !30, retainedNodes: !1025)
...
!1024 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !11)
!1025 = !{!1026, !1027}
!1026 = !DILocalVariable(name: ".global_tid.", arg: 1, scope: !1018, type: !1021, flags: DIFlagArtificial)
!1027 = !DILocalVariable(name: ".bound_tid.", arg: 2, scope: !1018, type: !1021, flags: DIFlagArtificial)
!1028 = !{!1029, !1029, i64 0}
!1029 = !{!"any pointer", !1009, i64 0}
!1030 = !DILocation(line: 0, scope: !1018)
!1031 = !DILocation(line: 74, column: 13, scope: !1032)
!1032 = distinct !DILexicalBlock(scope: !1018, file: !31, line: 73, column: 3)
!1033 = !DILocation(line: 75, column: 14, scope: !1032)
!1034 = !DILocation(line: 76, column: 3, scope: !1018)
!1035 = distinct !DISubprogram(name: ".omp_outlined.", scope: !31, file: !31, line: 72, type: !1019, scopeLine: 72, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !30, retainedNodes: !1036)
!1036 = !{!1037, !1038}
!1037 = !DILocalVariable(name: ".global_tid.", arg: 1, scope: !1035, type: !1021, flags: DIFlagArtificial)
!1038 = !DILocalVariable(name: ".bound_tid.", arg: 2, scope: !1035, type: !1021, flags: DIFlagArtificial)
!1039 = !DILocation(line: 0, scope: !1035)
!1040 = !DILocation(line: 72, column: 3, scope: !1035)
!1041 = !{!1042}
!1042 = !{i64 2, i64 -1, i64 -1, i1 true}
!1043 = distinct !DISubprogram(name: "operator<<<std::char_traits<char> >", linkageName: "_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc", scope: !2, file: !1044, line: 606, type: !1045, scopeLine: 607, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !30, templateParams: !1053, retainedNodes: !1050)
!1044 = !DIFile(filename: "/usr/bin/../lib64/gcc/x86_64-pc-linux-gnu/10.2.0/../../../../include/c++/10.2.0/ostream", directory: "")
!1045 = !DISubroutineType(types: !1046)
!1046 = !{!1047, !1047, !190}
!1047 = !DIDerivedType(tag: DW_TAG_reference_type, baseType: !1048, size: 64)
!1048 = !DICompositeType(tag: DW_TAG_class_type, name: "basic_ostream<char, std::char_traits<char> >", scope: !2, file: !1049, line: 359, flags: DIFlagFwdDecl | DIFlagNonTrivial)
!1049 = !DIFile(filename: "/usr/bin/../lib64/gcc/x86_64-pc-linux-gnu/10.2.0/../../../../include/c++/10.2.0/bits/ostream.tcc", directory: "")
!1050 = !{!1051, !1052}
!1051 = !DILocalVariable(name: "__out", arg: 1, scope: !1043, file: !1044, line: 606, type: !1047)
!1052 = !DILocalVariable(name: "__s", arg: 2, scope: !1043, file: !1044, line: 606, type: !190)
!1053 = !{!1054}
!1054 = !DITemplateTypeParameter(name: "_Traits", type: !1055)
!1055 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "char_traits<char>", scope: !2, file: !1056, line: 309, size: 8, flags: DIFlagTypePassByValue, elements: !1057, templateParams: !1106, identifier: "_ZTSSt11char_traitsIcE")
!1056 = !DIFile(filename: "/usr/bin/../lib64/gcc/x86_64-pc-linux-gnu/10.2.0/../../../../include/c++/10.2.0/bits/char_traits.h", directory: "")
!1057 = !{!1058, !1065, !1068, !1069, !1074, !1077, !1080, !1084, !1085, !1088, !1094, !1097, !1100, !1103}
!1058 = !DISubprogram(name: "assign", linkageName: "_ZNSt11char_traitsIcE6assignERcRKc", scope: !1055, file: !1056, line: 321, type: !1059, scopeLine: 321, flags: DIFlagPrototyped | DIFlagStaticMember, spFlags: DISPFlagOptimized)
!1059 = !DISubroutineType(types: !1060)
!1060 = !{null, !1061, !1063}
!1061 = !DIDerivedType(tag: DW_TAG_reference_type, baseType: !1062, size: 64)
!1062 = !DIDerivedType(tag: DW_TAG_typedef, name: "char_type", scope: !1055, file: !1056, line: 311, baseType: !74)
!1063 = !DIDerivedType(tag: DW_TAG_reference_type, baseType: !1064, size: 64)
!1064 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !1062)
!1065 = !DISubprogram(name: "eq", linkageName: "_ZNSt11char_traitsIcE2eqERKcS2_", scope: !1055, file: !1056, line: 325, type: !1066, scopeLine: 325, flags: DIFlagPrototyped | DIFlagStaticMember, spFlags: DISPFlagOptimized)
!1066 = !DISubroutineType(types: !1067)
!1067 = !{!13, !1063, !1063}
!1068 = !DISubprogram(name: "lt", linkageName: "_ZNSt11char_traitsIcE2ltERKcS2_", scope: !1055, file: !1056, line: 329, type: !1066, scopeLine: 329, flags: DIFlagPrototyped | DIFlagStaticMember, spFlags: DISPFlagOptimized)
!1069 = !DISubprogram(name: "compare", linkageName: "_ZNSt11char_traitsIcE7compareEPKcS2_m", scope: !1055, file: !1056, line: 337, type: !1070, scopeLine: 337, flags: DIFlagPrototyped | DIFlagStaticMember, spFlags: DISPFlagOptimized)
!1070 = !DISubroutineType(types: !1071)
!1071 = !{!11, !1072, !1072, !1073}
!1072 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1064, size: 64)
!1073 = !DIDerivedType(tag: DW_TAG_typedef, name: "size_t", scope: !2, file: !46, line: 260, baseType: !144)
!1074 = !DISubprogram(name: "length", linkageName: "_ZNSt11char_traitsIcE6lengthEPKc", scope: !1055, file: !1056, line: 351, type: !1075, scopeLine: 351, flags: DIFlagPrototyped | DIFlagStaticMember, spFlags: DISPFlagOptimized)
!1075 = !DISubroutineType(types: !1076)
!1076 = !{!1073, !1072}
!1077 = !DISubprogram(name: "find", linkageName: "_ZNSt11char_traitsIcE4findEPKcmRS1_", scope: !1055, file: !1056, line: 361, type: !1078, scopeLine: 361, flags: DIFlagPrototyped | DIFlagStaticMember, spFlags: DISPFlagOptimized)
!1078 = !DISubroutineType(types: !1079)
!1079 = !{!1072, !1072, !1073, !1063}
!1080 = !DISubprogram(name: "move", linkageName: "_ZNSt11char_traitsIcE4moveEPcPKcm", scope: !1055, file: !1056, line: 375, type: !1081, scopeLine: 375, flags: DIFlagPrototyped | DIFlagStaticMember, spFlags: DISPFlagOptimized)
!1081 = !DISubroutineType(types: !1082)
!1082 = !{!1083, !1083, !1072, !1073}
!1083 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1062, size: 64)
!1084 = !DISubprogram(name: "copy", linkageName: "_ZNSt11char_traitsIcE4copyEPcPKcm", scope: !1055, file: !1056, line: 387, type: !1081, scopeLine: 387, flags: DIFlagPrototyped | DIFlagStaticMember, spFlags: DISPFlagOptimized)
!1085 = !DISubprogram(name: "assign", linkageName: "_ZNSt11char_traitsIcE6assignEPcmc", scope: !1055, file: !1056, line: 399, type: !1086, scopeLine: 399, flags: DIFlagPrototyped | DIFlagStaticMember, spFlags: DISPFlagOptimized)
!1086 = !DISubroutineType(types: !1087)
!1087 = !{!1083, !1083, !1073, !1062}
!1088 = !DISubprogram(name: "to_char_type", linkageName: "_ZNSt11char_traitsIcE12to_char_typeERKi", scope: !1055, file: !1056, line: 411, type: !1089, scopeLine: 411, flags: DIFlagPrototyped | DIFlagStaticMember, spFlags: DISPFlagOptimized)
...
!1093 = !DIDerivedType(tag: DW_TAG_typedef, name: "int_type", scope: !1055, file: !1056, line: 312, baseType: !11)
!1094 = !DISubprogram(name: "to_int_type", linkageName: "_ZNSt11char_traitsIcE11to_int_typeERKc", scope: !1055, file: !1056, line: 417, type: !1095, scopeLine: 417, flags: DIFlagPrototyped | DIFlagStaticMember, spFlags: DISPFlagOptimized)
!1095 = !DISubroutineType(types: !1096)
!1096 = !{!1093, !1063}
!1097 = !DISubprogram(name: "eq_int_type", linkageName: "_ZNSt11char_traitsIcE11eq_int_typeERKiS2_", scope: !1055, file: !1056, line: 421, type: !1098, scopeLine: 421, flags: DIFlagPrototyped | DIFlagStaticMember, spFlags: DISPFlagOptimized)
!1098 = !DISubroutineType(types: !1099)
!1099 = !{!13, !1091, !1091}
!1100 = !DISubprogram(name: "eof", linkageName: "_ZNSt11char_traitsIcE3eofEv", scope: !1055, file: !1056, line: 425, type: !1101, scopeLine: 425, flags: DIFlagPrototyped | DIFlagStaticMember, spFlags: DISPFlagOptimized)
!1101 = !DISubroutineType(types: !1102)
!1102 = !{!1093}
!1103 = !DISubprogram(name: "not_eof", linkageName: "_ZNSt11char_traitsIcE7not_eofERKi", scope: !1055, file: !1056, line: 429, type: !1104, scopeLine: 429, flags: DIFlagPrototyped | DIFlagStaticMember, spFlags: DISPFlagOptimized)
!1104 = !DISubroutineType(types: !1105)
!1105 = !{!1093, !1091}
!1106 = !{!1107}
!1107 = !DITemplateTypeParameter(name: "_CharT", type: !74)
!1108 = !DILocation(line: 606, column: 46, scope: !1043)
!1109 = !DILocation(line: 606, column: 65, scope: !1043)
!1110 = !DILocation(line: 608, column: 12, scope: !1111)
!1111 = distinct !DILexicalBlock(scope: !1043, file: !1044, line: 608, column: 11)
!1112 = !DILocation(line: 608, column: 11, scope: !1043)
!1113 = !DILocation(line: 609, column: 2, scope: !1111)
!1114 = !{!1115, !1115, i64 0}
!1115 = !{!"vtable pointer", !1010, i64 0}
!1116 = !DILocation(line: 609, column: 8, scope: !1111)
!1117 = !DILocation(line: 611, column: 19, scope: !1111)
!1118 = !DILocation(line: 611, column: 26, scope: !1111)
!1119 = !DILocation(line: 612, column: 45, scope: !1111)
!1120 = !DILocation(line: 612, column: 29, scope: !1111)
!1121 = !DILocation(line: 611, column: 2, scope: !1111)
!1122 = !DILocation(line: 613, column: 14, scope: !1043)
!1123 = !DILocation(line: 613, column: 7, scope: !1043)
!1124 = distinct !DISubprogram(name: "operator<<", linkageName: "_ZNSolsEPFRSoS_E", scope: !1048, file: !1044, line: 108, type: !1125, scopeLine: 109, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !30, declaration: !1133, retainedNodes: !1134)
!1125 = !DISubroutineType(types: !1126)
!1126 = !{!1127, !1129, !1130}
!1127 = !DIDerivedType(tag: DW_TAG_reference_type, baseType: !1128, size: 64)
!1128 = !DIDerivedType(tag: DW_TAG_typedef, name: "__ostream_type", scope: !1048, file: !1044, line: 71, baseType: !1048)
!1129 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1048, size: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!1130 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1131, size: 64)
!1131 = !DISubroutineType(types: !1132)
!1132 = !{!1127, !1127}
!1133 = !DISubprogram(name: "operator<<", linkageName: "_ZNSolsEPFRSoS_E", scope: !1048, file: !1044, line: 108, type: !1125, scopeLine: 108, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagOptimized)
!1134 = !{!1135, !1137}
!1135 = !DILocalVariable(name: "this", arg: 1, scope: !1124, type: !1136, flags: DIFlagArtificial | DIFlagObjectPointer)
!1136 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1048, size: 64)
!1137 = !DILocalVariable(name: "__pf", arg: 2, scope: !1124, file: !1044, line: 108, type: !1130)
!1138 = !DILocation(line: 0, scope: !1124)
!1139 = !DILocation(line: 108, column: 36, scope: !1124)
!1140 = !DILocation(line: 113, column: 9, scope: !1124)
!1141 = !DILocation(line: 113, column: 2, scope: !1124)
!1142 = distinct !DISubprogram(name: "endl<char, std::char_traits<char> >", linkageName: "_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_", scope: !2, file: !1044, line: 681, type: !1143, scopeLine: 682, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !30, templateParams: !1147, retainedNodes: !1145)
!1143 = !DISubroutineType(types: !1144)
!1144 = !{!1047, !1047}
!1145 = !{!1146}
!1146 = !DILocalVariable(name: "__os", arg: 1, scope: !1142, file: !1044, line: 681, type: !1047)
!1147 = !{!1107, !1054}
!1148 = !DILocation(line: 681, column: 42, scope: !1142)
!1149 = !DILocation(line: 682, column: 20, scope: !1142)
!1150 = !DILocation(line: 682, column: 29, scope: !1142)
!1151 = !DILocation(line: 682, column: 34, scope: !1142)
!1152 = !DILocation(line: 682, column: 25, scope: !1142)
!1153 = !DILocation(line: 682, column: 14, scope: !1142)
!1154 = !DILocation(line: 682, column: 7, scope: !1142)
!1155 = distinct !DISubprogram(name: "setstate", linkageName: "_ZNSt9basic_iosIcSt11char_traitsIcEE8setstateESt12_Ios_Iostate", scope: !1157, file: !1156, line: 157, type: !1159, scopeLine: 158, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !30, declaration: !1163, retainedNodes: !1164)
!1156 = !DIFile(filename: "/usr/bin/../lib64/gcc/x86_64-pc-linux-gnu/10.2.0/../../../../include/c++/10.2.0/bits/basic_ios.h", directory: "")
!1157 = !DICompositeType(tag: DW_TAG_class_type, name: "basic_ios<char, std::char_traits<char> >", scope: !2, file: !1158, line: 178, flags: DIFlagFwdDecl | DIFlagNonTrivial)
!1158 = !DIFile(filename: "/usr/bin/../lib64/gcc/x86_64-pc-linux-gnu/10.2.0/../../../../include/c++/10.2.0/bits/basic_ios.tcc", directory: "")
!1159 = !DISubroutineType(types: !1160)
!1160 = !{null, !1161, !1162}
!1161 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1157, size: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!1162 = !DIDerivedType(tag: DW_TAG_typedef, name: "iostate", scope: !6, file: !5, line: 398, baseType: !33)
...
!1170 = !{!"_ZTSSt12_Ios_Iostate", !1009, i64 0}
...
!1177 = distinct !DISubprogram(name: "length", linkageName: "_ZNSt11char_traitsIcE6lengthEPKc", scope: !1055, file: !1056, line: 351, type: !1075, scopeLine: 352, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !30, declaration: !1074, retainedNodes: !1178)
!1178 = !{!1179}
!1179 = !DILocalVariable(name: "__s", arg: 1, scope: !1177, file: !1056, line: 351, type: !1072)
...
!1184 = distinct !DISubprogram(name: "operator|", linkageName: "_ZStorSt12_Ios_IostateS_", scope: !2, file: !5, line: 169, type: !1185, scopeLine: 170, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !30, retainedNodes: !1187)
!1185 = !DISubroutineType(types: !1186)
!1186 = !{!33, !33, !33}
!1187 = !{!1188, !1189}
!1188 = !DILocalVariable(name: "__a", arg: 1, scope: !1184, file: !5, line: 169, type: !33)
!1189 = !DILocalVariable(name: "__b", arg: 2, scope: !1184, file: !5, line: 169, type: !33)
...
!1196 = distinct !DISubprogram(name: "rdstate", linkageName: "_ZNKSt9basic_iosIcSt11char_traitsIcEE7rdstateEv", scope: !1157, file: !1156, line: 137, type: !1197, scopeLine: 138, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !30, declaration: !1201, retainedNodes: !1202)
...
!1208 = !{!"_ZTSSt8ios_base", !1209, i64 8, !1209, i64 16, !1210, i64 24, !1170, i64 28, !1170, i64 32, !1029, i64 40, !1211, i64 48, !1009, i64 64, !1008, i64 192, !1029, i64 200, !1212, i64 208}
!1209 = !{!"long", !1009, i64 0}
!1210 = !{!"_ZTSSt13_Ios_Fmtflags", !1009, i64 0}
!1211 = !{!"_ZTSNSt8ios_base6_WordsE", !1029, i64 0, !1209, i64 8}
!1212 = !{!"_ZTSSt6locale", !1029, i64 0}
!1213 = !DILocation(line: 138, column: 9, scope: !1196)
!1214 = distinct !DISubprogram(name: "flush<char, std::char_traits<char> >", linkageName: "_ZSt5flushIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_", scope: !2, file: !1044, line: 703, type: !1143, scopeLine: 704, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !30, templateParams: !1147, retainedNodes: !1215)
!1215 = !{!1216}
!1216 = !DILocalVariable(name: "__os", arg: 1, scope: !1214, file: !1044, line: 703, type: !1047)
...
!1221 = distinct !DISubprogram(name: "widen", linkageName: "_ZNKSt9basic_iosIcSt11char_traitsIcEE5widenEc", scope: !1157, file: !1156, line: 449, type: !1222, scopeLine: 450, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !30, declaration: !1225, retainedNodes: !1226)
...
!1230 = !{!1009, !1009, i64 0}
!1231 = !DILocation(line: 449, column: 18, scope: !1221)
!1232 = !DILocation(line: 450, column: 30, scope: !1221)
!1233 = !{!1234, !1029, i64 240}
!1234 = !{!"_ZTSSt9basic_iosIcSt11char_traitsIcEE", !1029, i64 216, !1009, i64 224, !1235, i64 225, !1029, i64 232, !1029, i64 240, !1029, i64 248, !1029, i64 256}
!1235 = !{!"bool", !1009, i64 0}
...
!1240 = distinct !DISubprogram(name: "__check_facet<std::ctype<char> >", linkageName: "_ZSt13__check_facetISt5ctypeIcEERKT_PS3_", scope: !2, file: !1156, line: 47, type: !1241, scopeLine: 48, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !30, templateParams: !1250, retainedNodes: !1248)
...
!1245 = !DICompositeType(tag: DW_TAG_class_type, name: "ctype<char>", scope: !2, file: !1246, line: 681, flags: DIFlagFwdDecl | DIFlagNonTrivial, identifier: "_ZTSSt5ctypeIcE")
!1246 = !DIFile(filename: "/usr/bin/../lib64/gcc/x86_64-pc-linux-gnu/10.2.0/../../../../include/c++/10.2.0/bits/locale_facets.h", directory: "")
...
!1259 = distinct !DISubprogram(name: "widen", linkageName: "_ZNKSt5ctypeIcE5widenEc", scope: !1245, file: !1246, line: 872, type: !1260, scopeLine: 873, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !30, declaration: !1264, retainedNodes: !1265)
...
!1272 = !{!1273, !1009, i64 56}
!1273 = !{!"_ZTSSt5ctypeIcE", !1029, i64 16, !1235, i64 24, !1029, i64 32, !1029, i64 40, !1029, i64 48, !1009, i64 56, !1009, i64 57, !1009, i64 313, !1009, i64 569}
...
!1283 = distinct !DISubprogram(linkageName: "_GLOBAL__sub_I_DRB087_static_data_member2_orig_yes.cpp", scope: !31, file: !31, type: !1284, flags: DIFlagArtificial | DIFlagAllCallsDescribed, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !30, retainedNodes: !1002)
!1284 = !DISubroutineType(types: !1002)
