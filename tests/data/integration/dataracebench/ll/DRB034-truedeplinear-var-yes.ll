; ModuleID = 'DRB034-truedeplinear-var-yes.c'
source_filename = "DRB034-truedeplinear-var-yes.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-linux-gnu"

%struct.ident_t = type { i32, i32, i32, i32, i8* }

@0 = private unnamed_addr constant [44 x i8] c";DRB034-truedeplinear-var-yes.c;main;64;1;;\00", align 1
...
@2 = private unnamed_addr constant [45 x i8] c";DRB034-truedeplinear-var-yes.c;main;64;25;;\00", align 1
...
entry:
  ...
  store i32 2000, i32* %len, align 4, !dbg !40, !tbaa !29
...
entry:
  ...
  %div = sdiv i32 %5, 2, !dbg !114
  store i32 %div, i32* %.capture_expr., align 4, !dbg !113, !tbaa !29
  ...
  %div2 = sdiv i32 %sub, 1, !dbg !112
  %sub3 = sub nsw i32 %div2, 1, !dbg !112
...
omp.inner.for.body:                               ; preds = %omp.inner.for.cond
  ...
  %mul8 = mul nsw i32 2, %29, !dbg !122
  %add9 = add nsw i32 %mul8, 1, !dbg !123
  %idxprom10 = sext i32 %add9 to i64, !dbg !124
  %arrayidx11 = getelementptr inbounds i32, i32* %2, i64 %idxprom10, !dbg !124
  store i32 %add7, i32* %arrayidx11, align 4, !dbg !125, !tbaa !29
...
omp.inner.for.inc:                                ; preds = %omp.body.continue
  ...
  %add12 = add nsw i32 %30, 1, !dbg !112
  store i32 %add12, i32* %.omp.iv, align 4, !dbg !112, !tbaa !29
  br label %omp.inner.for.cond, !dbg !117, !llvm.loop !126
...
omp.loop.exit:                                    ; preds = %omp.inner.for.end
  ...
  call void @__kmpc_for_static_fini(%struct.ident_t* @3, i32 %32), !dbg !127
...
; Function Attrs: norecurse nounwind sspstrong uwtable
define internal void @.omp_outlined.(i32* noalias %.global_tid., i32* noalias %.bound_tid., i32* nonnull align 4 dereferenceable(4) %len, i64 %vla, i32* nonnull align 4 dereferenceable(4) %a) #5 !dbg !129 {
entry:
  %.global_tid..addr = alloca i32*, align 8
  %.bound_tid..addr = alloca i32*, align 8
  %len.addr = alloca i32*, align 8
  ...
  %a.addr = alloca i32*, align 8
  store i32* %.global_tid., i32** %.global_tid..addr, align 8, !tbaa !34
  call void @llvm.dbg.declare(metadata i32** %.global_tid..addr, metadata !131, metadata !DIExpression()), !dbg !136
  store i32* %.bound_tid., i32** %.bound_tid..addr, align 8, !tbaa !34
  call void @llvm.dbg.declare(metadata i32** %.bound_tid..addr, metadata !132, metadata !DIExpression()), !dbg !136
  store i32* %len, i32** %len.addr, align 8, !tbaa !34
  call void @llvm.dbg.declare(metadata i32** %len.addr, metadata !133, metadata !DIExpression()), !dbg !136
  store i64 %vla, i64* %vla.addr, align 8, !tbaa !109
  call void @llvm.dbg.declare(metadata i64* %vla.addr, metadata !134, metadata !DIExpression()), !dbg !136
  store i32* %a, i32** %a.addr, align 8, !tbaa !34
  call void @llvm.dbg.declare(metadata i32** %a.addr, metadata !135, metadata !DIExpression()), !dbg !136
  %0 = load i32*, i32** %len.addr, align 8, !dbg !137, !tbaa !34
  %1 = load i64, i64* %vla.addr, align 8, !dbg !137, !tbaa !109
  %2 = load i32*, i32** %a.addr, align 8, !dbg !137, !tbaa !34
  %3 = load i32*, i32** %.global_tid..addr, align 8, !dbg !137, !tbaa !34
  %4 = load i32*, i32** %.bound_tid..addr, align 8, !dbg !137, !tbaa !34
  %5 = load i32*, i32** %len.addr, align 8, !dbg !137, !tbaa !34
  %6 = load i32*, i32** %a.addr, align 8, !dbg !137, !tbaa !34
  call void @.omp_outlined._debug__(i32* %3, i32* %4, i32* %5, i64 %1, i32* %6) #4, !dbg !137
  ret void, !dbg !137
}

; Function Attrs: nounwind
declare !callback !138 void @__kmpc_fork_call(%struct.ident_t*, i32, void (i32*, i32*, ...)*, ...) #4
...
!1 = !DIFile(filename: "DRB034-truedeplinear-var-yes.c", directory: "/home/peiming/Documents/projects/OpenRace/tests/data/integration/dataracebench")
!2 = !{}
!3 = !{!4, !5, !8}
...
!25 = !DILocalVariable(name: "a", scope: !15, file: !1, line: 59, type: !26)
...
!32 = !{!"Simple C/C++ TBAA"}
!33 = !DILocation(line: 52, column: 14, scope: !15)
!34 = !{!35, !35, i64 0}
!35 = !{!"any pointer", !31, i64 0}
!36 = !DILocation(line: 52, column: 26, scope: !15)
!37 = !DILocation(line: 54, column: 3, scope: !15)
!38 = !DILocation(line: 54, column: 7, scope: !15)
!39 = !DILocation(line: 55, column: 3, scope: !15)
!40 = !DILocation(line: 55, column: 7, scope: !15)
!41 = !DILocation(line: 57, column: 7, scope: !42)
!42 = distinct !DILexicalBlock(scope: !15, file: !1, line: 57, column: 7)
...
!49 = !DILocation(line: 59, column: 9, scope: !15)
!50 = !DILocation(line: 59, column: 3, scope: !15)
!51 = !DILocation(line: 0, scope: !15)
!52 = !DILocation(line: 59, column: 7, scope: !15)
!53 = !DILocation(line: 61, column: 9, scope: !54)
!54 = distinct !DILexicalBlock(scope: !15, file: !1, line: 61, column: 3)
!55 = !DILocation(line: 61, column: 8, scope: !54)
!56 = !DILocation(line: 61, column: 13, scope: !57)
!57 = distinct !DILexicalBlock(scope: !54, file: !1, line: 61, column: 3)
!58 = !DILocation(line: 61, column: 15, scope: !57)
!59 = !DILocation(line: 61, column: 14, scope: !57)
!60 = !DILocation(line: 61, column: 3, scope: !54)
!61 = !DILocation(line: 62, column: 10, scope: !57)
!62 = !DILocation(line: 62, column: 7, scope: !57)
!63 = !DILocation(line: 62, column: 5, scope: !57)
!64 = !DILocation(line: 62, column: 9, scope: !57)
!65 = !DILocation(line: 61, column: 21, scope: !57)
!66 = !DILocation(line: 61, column: 3, scope: !57)
!67 = distinct !{!67, !60, !68, !69}
!68 = !DILocation(line: 62, column: 10, scope: !54)
!69 = !{!"llvm.loop.unroll.disable"}
!70 = !DILocation(line: 64, column: 1, scope: !15)
!71 = !DILocation(line: 68, column: 3, scope: !15)
!72 = !DILocation(line: 69, column: 1, scope: !15)
...
!86 = distinct !DISubprogram(name: ".omp_outlined._debug__", scope: !1, file: !1, line: 65, type: !87, scopeLine: 65, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !94)
...
!97 = !DILocalVariable(name: "len", arg: 3, scope: !86, file: !1, line: 55, type: !93)
!98 = !DILocalVariable(name: "vla", arg: 4, scope: !86, type: !24, flags: DIFlagArtificial)
!99 = !DILocalVariable(name: "a", arg: 5, scope: !86, file: !1, line: 59, type: !93)
...
!108 = !DILocation(line: 55, column: 7, scope: !86)
!109 = !{!110, !110, i64 0}
!110 = !{!"long", !31, i64 0}
!111 = !DILocation(line: 59, column: 7, scope: !86)
!112 = !DILocation(line: 65, column: 3, scope: !86)
!113 = !DILocation(line: 65, column: 14, scope: !86)
!114 = !DILocation(line: 65, column: 17, scope: !86)
!115 = !DILocation(line: 65, column: 20, scope: !86)
!116 = !DILocation(line: 65, column: 8, scope: !86)
!117 = !DILocation(line: 64, column: 1, scope: !86)
!118 = !DILocation(line: 66, column: 16, scope: !86)
!119 = !DILocation(line: 66, column: 14, scope: !86)
!120 = !DILocation(line: 66, column: 18, scope: !86)
!121 = !DILocation(line: 66, column: 9, scope: !86)
!122 = !DILocation(line: 66, column: 8, scope: !86)
!123 = !DILocation(line: 66, column: 10, scope: !86)
!124 = !DILocation(line: 66, column: 5, scope: !86)
!125 = !DILocation(line: 66, column: 13, scope: !86)
!126 = distinct !{!126, !117, !127}
!127 = !DILocation(line: 64, column: 25, scope: !86)
!128 = !DILocation(line: 66, column: 19, scope: !86)
!129 = distinct !DISubprogram(name: ".omp_outlined.", scope: !1, file: !1, line: 64, type: !87, scopeLine: 64, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !130)
!130 = !{!131, !132, !133, !134, !135}
!131 = !DILocalVariable(name: ".global_tid.", arg: 1, scope: !129, type: !89, flags: DIFlagArtificial)
!132 = !DILocalVariable(name: ".bound_tid.", arg: 2, scope: !129, type: !89, flags: DIFlagArtificial)
!133 = !DILocalVariable(name: "len", arg: 3, scope: !129, type: !93, flags: DIFlagArtificial)
!134 = !DILocalVariable(name: "vla", arg: 4, scope: !129, type: !24, flags: DIFlagArtificial)
!135 = !DILocalVariable(name: "a", arg: 5, scope: !129, type: !93, flags: DIFlagArtificial)
!136 = !DILocation(line: 0, scope: !129)
!137 = !DILocation(line: 64, column: 1, scope: !129)
!138 = !{!139}
