...
@0 = private unnamed_addr constant [45 x i8] c";DRB122-taskundeferred-orig-no.c;main;25;3;;\00", align 1
@1 = private unnamed_addr constant %struct.ident_t { i32 0, i32 1026, i32 0, i32 0, i8* getelementptr inbounds ([45 x i8], [45 x i8]* @0, i32 0, i32 0) }, align 8
...
@4 = private unnamed_addr constant [46 x i8] c";DRB122-taskundeferred-orig-no.c;main;25;33;;\00", align 1
@5 = private unnamed_addr constant %struct.ident_t { i32 0, i32 1026, i32 0, i32 0, i8* getelementptr inbounds ([46 x i8], [46 x i8]* @4, i32 0, i32 0) }, align 8
...
entry:
  ...
  %4 = bitcast i32* %var to i8*, !dbg !36
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %4) #5, !dbg !36
  ret i32 0, !dbg !37
}
...
define internal void @.omp_outlined._debug__(i32* noalias %.global_tid., i32* noalias %.bound_tid., i32* nonnull align 4 dereferenceable(4) %i, i32* nonnull align 4 dereferenceable(4) %var) #3 !dbg !38 {
entry:
  ...
  %0 = load i32*, i32** %i.addr, align 8, !dbg !54, !tbaa !26
  %1 = load i32*, i32** %var.addr, align 8, !dbg !54, !tbaa !26
  store i32 0, i32* %.omp.sections.lb., align 4, !dbg !54, !tbaa !21
  store i32 0, i32* %.omp.sections.ub., align 4, !dbg !54, !tbaa !21
  store i32 1, i32* %.omp.sections.st., align 4, !dbg !54, !tbaa !21
  store i32 0, i32* %.omp.sections.il., align 4, !dbg !54, !tbaa !21
  %2 = load i32*, i32** %.global_tid..addr, align 8, !dbg !54
  %3 = load i32, i32* %2, align 4, !dbg !54, !tbaa !21
  call void @__kmpc_for_static_init_4(%struct.ident_t* @1, i32 %3, i32 34, i32* %.omp.sections.il., i32* %.omp.sections.lb., i32* %.omp.sections.ub., i32* %.omp.sections.st., i32 1, i32 1), !dbg !55
  %4 = load i32, i32* %.omp.sections.ub., align 4, !dbg !54, !tbaa !21
  %5 = icmp slt i32 %4, 0, !dbg !54
  %6 = select i1 %5, i32 %4, i32 0, !dbg !54
  store i32 %6, i32* %.omp.sections.ub., align 4, !dbg !54, !tbaa !21
  %7 = load i32, i32* %.omp.sections.lb., align 4, !dbg !54, !tbaa !21
  store i32 %7, i32* %.omp.sections.iv., align 4, !dbg !54, !tbaa !21
  br label %omp.inner.for.cond, !dbg !54

omp.inner.for.cond:                               ; preds = %omp.inner.for.inc, %entry
  %8 = load i32, i32* %.omp.sections.iv., align 4, !dbg !55, !tbaa !21
  %9 = load i32, i32* %.omp.sections.ub., align 4, !dbg !55, !tbaa !21
  %cmp = icmp sle i32 %8, %9, !dbg !55
  br i1 %cmp, label %omp.inner.for.body, label %omp.inner.for.end, !dbg !54

omp.inner.for.body:                               ; preds = %omp.inner.for.cond
  %10 = load i32, i32* %.omp.sections.iv., align 4, !dbg !54, !tbaa !21
  switch i32 %10, label %.omp.sections.exit [
    i32 0, label %.omp.sections.case
  ], !dbg !54

.omp.sections.case:                               ; preds = %omp.inner.for.body
  store i32 0, i32* %0, align 4, !dbg !56, !tbaa !21
  br label %for.cond, !dbg !58

for.cond:                                         ; preds = %for.inc, %.omp.sections.case
  %11 = load i32, i32* %0, align 4, !dbg !59, !tbaa !21
  %cmp1 = icmp slt i32 %11, 10, !dbg !61
  br i1 %cmp1, label %for.body, label %for.end, !dbg !62

for.body:                                         ; preds = %for.cond
  %12 = getelementptr inbounds %struct.anon, %struct.anon* %agg.captured, i32 0, i32 0, !dbg !63
  store i32* %1, i32** %12, align 8, !dbg !63, !tbaa !26
  %13 = call i8* @__kmpc_omp_task_alloc(%struct.ident_t* @3, i32 %3, i32 1, i64 40, i64 8, i32 (i32, i8*)* bitcast (i32 (i32, %struct.kmp_task_t_with_privates*)* @.omp_task_entry. to i32 (i32, i8*)*)), !dbg !63
  %14 = bitcast i8* %13 to %struct.kmp_task_t_with_privates*, !dbg !63
  %15 = getelementptr inbounds %struct.kmp_task_t_with_privates, %struct.kmp_task_t_with_privates* %14, i32 0, i32 0, !dbg !63
  %16 = getelementptr inbounds %struct.kmp_task_t, %struct.kmp_task_t* %15, i32 0, i32 0, !dbg !63
  %17 = load i8*, i8** %16, align 8, !dbg !63, !tbaa !65
  %18 = bitcast %struct.anon* %agg.captured to i8*, !dbg !63
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %17, i8* align 8 %18, i64 8, i1 false), !dbg !63, !tbaa.struct !68
  call void @__kmpc_omp_task_begin_if0(%struct.ident_t* @3, i32 %3, i8* %13), !dbg !69
  %19 = call i32 @.omp_task_entry.(i32 %3, %struct.kmp_task_t_with_privates* %14) #5, !dbg !71
  call void @__kmpc_omp_task_complete_if0(%struct.ident_t* @3, i32 %3, i8* %13), !dbg !69
...
omp.inner.for.inc:                                ; preds = %.omp.sections.exit
  %21 = load i32, i32* %.omp.sections.iv., align 4, !dbg !55, !tbaa !21
  %inc2 = add nsw i32 %21, 1, !dbg !55
  store i32 %inc2, i32* %.omp.sections.iv., align 4, !dbg !55, !tbaa !21
...
entry:
  ...
  %7 = load i8*, i8** %6, align 8, !dbg !129, !tbaa !65
...
!1 = !DIFile(filename: "DRB122-taskundeferred-orig-no.c", directory: "/home/peiming/Documents/projects/OpenRace/tests/data/integration/dataracebench")
!2 = !{}
...
!34 = !DILocation(line: 35, column: 17, scope: !9)
!35 = !DILocation(line: 35, column: 3, scope: !9)
...
!67 = !{!"kmp_task_t", !27, i64 0, !27, i64 8, !22, i64 16, !23, i64 24, !23, i64 32}
!68 = !{i64 0, i64 8, !26}
...
!80 = !DILocation(line: 25, column: 33, scope: !38)
!81 = !DILocation(line: 33, column: 3, scope: !38)
...
!97 = distinct !DICompositeType(tag: DW_TAG_structure_type, scope: !38, file: !1, line: 28, size: 64, elements: !2)
!98 = !{!99, !100, !101, !102, !103, !104}
!99 = !DILocalVariable(name: ".global_tid.", arg: 1, scope: !82, type: !44, flags: DIFlagArtificial)
!100 = !DILocalVariable(name: ".part_id.", arg: 2, scope: !82, type: !41, flags: DIFlagArtificial)
...
!130 = distinct !DISubprogram(name: ".omp_outlined..1", scope: !1, file: !1, line: 25, type: !39, scopeLine: 25, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !131)
!131 = !{!132, !133, !134, !135}
!132 = !DILocalVariable(name: ".global_tid.", arg: 1, scope: !130, type: !41, flags: DIFlagArtificial)
!133 = !DILocalVariable(name: ".bound_tid.", arg: 2, scope: !130, type: !41, flags: DIFlagArtificial)
!134 = !DILocalVariable(name: "i", arg: 3, scope: !130, type: !45, flags: DIFlagArtificial)
!135 = !DILocalVariable(name: "var", arg: 4, scope: !130, type: !45, flags: DIFlagArtificial)
