; ModuleID = 'DRB144-critical-missingreduction-orig-gpu-yes.c'
source_filename = "DRB144-critical-missingreduction-orig-gpu-yes.c"
...
@0 = private unnamed_addr constant [61 x i8] c";DRB144-critical-missingreduction-orig-gpu-yes.c;main;23;3;;\00", align 1
@1 = private unnamed_addr constant %struct.ident_t { i32 0, i32 2050, i32 0, i32 0, i8* getelementptr inbounds ([61 x i8], [61 x i8]* @0, i32 0, i32 0) }, align 8
@2 = private unnamed_addr constant %struct.ident_t { i32 0, i32 514, i32 0, i32 0, i8* getelementptr inbounds ([61 x i8], [61 x i8]* @0, i32 0, i32 0) }, align 8
@3 = private unnamed_addr constant [61 x i8] c";DRB144-critical-missingreduction-orig-gpu-yes.c;main;25;5;;\00", align 1
@4 = private unnamed_addr constant %struct.ident_t { i32 0, i32 2, i32 0, i32 0, i8* getelementptr inbounds ([61 x i8], [61 x i8]* @3, i32 0, i32 0) }, align 8
@.gomp_critical_user_.var = common global [8 x i32] zeroinitializer
@5 = private unnamed_addr constant [62 x i8] c";DRB144-critical-missingreduction-orig-gpu-yes.c;main;23;44;;\00", align 1
@6 = private unnamed_addr constant %struct.ident_t { i32 0, i32 2050, i32 0, i32 0, i8* getelementptr inbounds ([62 x i8], [62 x i8]* @5, i32 0, i32 0) }, align 8
@7 = private unnamed_addr constant %struct.ident_t { i32 0, i32 2, i32 0, i32 0, i8* getelementptr inbounds ([61 x i8], [61 x i8]* @0, i32 0, i32 0) }, align 8
...
entry:
  ...
  call void @__omp_offloading_10308_be0478_main_l22(i32* @var) #5, !dbg !16
...
define internal void @__omp_offloading_10308_be0478_main_l22_debug__(i32* nonnull align 4 dereferenceable(4) %var) #1 !dbg !25 {
entry:
  ...
  call void (%struct.ident_t*, i32, void (i32*, i32*, ...)*, ...) @__kmpc_fork_teams(%struct.ident_t* @7, i32 1, void (i32*, i32*, ...)* bitcast (void (i32*, i32*, i32*)* @.omp_outlined..2 to void (i32*, i32*, ...)*), i32* %0), !dbg !34
  ret void, !dbg !35
}
...
entry:
  ...
  store i32 199, i32* %.omp.comb.ub, align 4, !dbg !56, !tbaa !19
...
cond.end:                                         ; preds = %cond.false, %cond.true
  %cond = phi i32 [ 199, %cond.true ], [ %10, %cond.false ], !dbg !56
...
omp.inner.for.body:                               ; preds = %omp.inner.for.cond
  ...
  call void (%struct.ident_t*, i32, void (i32*, i32*, ...)*, ...) @__kmpc_fork_call(%struct.ident_t* @7, i32 3, void (i32*, i32*, ...)* bitcast (void (i32*, i32*, i64, i64, i32*)* @.omp_outlined. to void (i32*, i32*, ...)*), i64 %15, i64 %17, i32* %0), !dbg !57
...
omp.loop.exit:                                    ; preds = %omp.inner.for.end
  call void @__kmpc_for_static_fini(%struct.ident_t* @6, i32 %8), !dbg !61
...
entry:
  ...
  store i32 199, i32* %.omp.ub, align 4, !dbg !85, !tbaa !19
  ...
  %cmp = icmp sgt i32 %11, 199, !dbg !85
...
cond.end:                                         ; preds = %cond.false, %cond.true
  %cond = phi i32 [ 199, %cond.true ], [ %12, %cond.false ], !dbg !85
...
omp.inner.for.body:                               ; preds = %omp.inner.for.cond
  ...
  call void @__kmpc_critical(%struct.ident_t* @4, i32 %10, [8 x i32]* @.gomp_critical_user_.var), !dbg !88
  %17 = load i32, i32* %0, align 4, !dbg !90, !tbaa !19
  %inc = add nsw i32 %17, 1, !dbg !90
  store i32 %inc, i32* %0, align 4, !dbg !90, !tbaa !19
  call void @__kmpc_end_critical(%struct.ident_t* @4, i32 %10, [8 x i32]* @.gomp_critical_user_.var), !dbg !92
...
omp.inner.for.inc:                                ; preds = %omp.body.continue
  %18 = load i32, i32* %.omp.iv, align 4, !dbg !85, !tbaa !19
  %add5 = add nsw i32 %18, 1, !dbg !84
...
omp.loop.exit:                                    ; preds = %omp.inner.for.end
  call void @__kmpc_for_static_fini(%struct.ident_t* @6, i32 %10), !dbg !95
  %19 = bitcast i32* %i to i8*, !dbg !86
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %19) #5, !dbg !86
  %20 = bitcast i32* %.omp.is_last to i8*, !dbg !86
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %20) #5, !dbg !86
  %21 = bitcast i32* %.omp.stride to i8*, !dbg !86
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %21) #5, !dbg !86
  %22 = bitcast i32* %.omp.ub to i8*, !dbg !86
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %22) #5, !dbg !86
  %23 = bitcast i32* %.omp.lb to i8*, !dbg !86
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %23) #5, !dbg !86
  %24 = bitcast i32* %.omp.iv to i8*, !dbg !86
...
entry:
  ...
  call void @.omp_outlined._debug__.1(i32* %1, i32* %2, i64 %3, i64 %4, i32* %5) #5, !dbg !105
  ret void, !dbg !105
}

; Function Attrs: nounwind
declare !callback !106 void @__kmpc_fork_call(%struct.ident_t*, i32, void (i32*, i32*, ...)*, ...) #5
...
; Function Attrs: nounwind
declare !callback !106 void @__kmpc_fork_teams(%struct.ident_t*, i32, void (i32*, i32*, ...)*, ...) #5

; Function Attrs: norecurse nounwind sspstrong uwtable
define internal void @__omp_offloading_10308_be0478_main_l22(i32* nonnull align 4 dereferenceable(4) %var) #1 !dbg !115 {
entry:
  %var.addr = alloca i32*, align 8
  store i32* %var, i32** %var.addr, align 8, !tbaa !31
  ...
  call void @__omp_offloading_10308_be0478_main_l22_debug__(i32* %1) #5, !dbg !119
  ret void, !dbg !119
}
...
!3 = !DIFile(filename: "DRB144-critical-missingreduction-orig-gpu-yes.c", directory: "/home/peiming/Documents/projects/OpenRace/tests/data/integration/dataracebench")
!4 = !{}
!5 = !{!0}
...
!18 = !DILocation(line: 29, column: 18, scope: !13)
!19 = !{!20, !20, i64 0}
!20 = !{!"int", !21, i64 0}
!21 = !{!"omnipotent char", !22, i64 0}
!22 = !{!"Simple C/C++ TBAA"}
!23 = !DILocation(line: 29, column: 3, scope: !13)
!24 = !DILocation(line: 31, column: 3, scope: !13)
!25 = distinct !DISubprogram(name: "__omp_offloading_10308_be0478_main_l22_debug__", scope: !3, file: !3, line: 23, type: !26, scopeLine: 23, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !2, retainedNodes: !29)
...
!35 = !DILocation(line: 23, column: 44, scope: !25)
...
!54 = !DILocation(line: 19, column: 5, scope: !36)
!55 = !DILocation(line: 24, column: 3, scope: !36)
!56 = !DILocation(line: 24, column: 7, scope: !36)
!57 = !DILocation(line: 23, column: 3, scope: !36)
!58 = !DILocation(line: 23, column: 44, scope: !59)
!59 = distinct !DILexicalBlock(scope: !36, file: !3, line: 23, column: 3)
!60 = distinct !{!60, !57, !61}
!61 = !DILocation(line: 23, column: 44, scope: !36)
!62 = !DILocation(line: 27, column: 3, scope: !36)
!63 = distinct !DISubprogram(name: ".omp_outlined._debug__.1", scope: !3, file: !3, line: 24, type: !64, scopeLine: 24, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !2, retainedNodes: !68)
...
!73 = !DILocalVariable(name: "var", arg: 5, scope: !63, file: !3, line: 19, type: !28)
...
!81 = !{!82, !82, i64 0}
!82 = !{!"long", !21, i64 0}
!83 = !DILocation(line: 19, column: 5, scope: !63)
!84 = !DILocation(line: 24, column: 3, scope: !63)
!85 = !DILocation(line: 24, column: 7, scope: !63)
!86 = !DILocation(line: 23, column: 3, scope: !63)
!87 = !DILocation(line: 24, column: 23, scope: !63)
!88 = !DILocation(line: 25, column: 5, scope: !89)
!89 = distinct !DILexicalBlock(scope: !63, file: !3, line: 24, column: 27)
!90 = !DILocation(line: 26, column: 8, scope: !91)
!91 = distinct !DILexicalBlock(scope: !89, file: !3, line: 25, column: 5)
!92 = !DILocation(line: 26, column: 5, scope: !91)
!93 = !DILocation(line: 27, column: 3, scope: !89)
!94 = distinct !{!94, !86, !95}
!95 = !DILocation(line: 23, column: 44, scope: !63)
!96 = !DILocation(line: 27, column: 3, scope: !63)
!97 = distinct !DISubprogram(name: ".omp_outlined.", scope: !3, file: !3, line: 23, type: !64, scopeLine: 23, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !2, retainedNodes: !98)
...
!105 = !DILocation(line: 23, column: 3, scope: !97)
!106 = !{!107}
!107 = !{i64 2, i64 -1, i64 -1, i1 true}
!108 = distinct !DISubprogram(name: ".omp_outlined..2", scope: !3, file: !3, line: 23, type: !37, scopeLine: 23, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !2, retainedNodes: !109)
!109 = !{!110, !111, !112}
...
!114 = !DILocation(line: 23, column: 3, scope: !108)
!115 = distinct !DISubprogram(name: "__omp_offloading_10308_be0478_main_l22", scope: !3, file: !3, line: 22, type: !26, scopeLine: 22, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !2, retainedNodes: !116)
!116 = !{!117}
!117 = !DILocalVariable(name: "var", arg: 1, scope: !115, type: !28, flags: DIFlagArtificial)
!118 = !DILocation(line: 0, scope: !115)
!119 = !DILocation(line: 22, column: 3, scope: !115)
