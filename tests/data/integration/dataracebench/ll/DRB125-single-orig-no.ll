; ModuleID = 'DRB125-single-orig-no.c'
source_filename = "DRB125-single-orig-no.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-linux-gnu"

%struct.ident_t = type { i32, i32, i32, i32, i8* }

@0 = private unnamed_addr constant [37 x i8] c";DRB125-single-orig-no.c;main;31;5;;\00", align 1
...
@3 = private unnamed_addr constant [37 x i8] c";DRB125-single-orig-no.c;main;29;3;;\00", align 1
...
entry:
  ...
  call void (%struct.ident_t*, i32, void (i32*, i32*, ...)*, ...) @__kmpc_fork_call(%struct.ident_t* @4, i32 1, void (i32*, i32*, ...)* bitcast (void (i32*, i32*, i32*)* @.omp_outlined. to void (i32*, i32*, ...)*), i32* %init), !dbg !32
...
entry:
  ...
  %4 = call i32 @__kmpc_single(%struct.ident_t* @1, i32 %3), !dbg !51
  %5 = icmp ne i32 %4, 0, !dbg !51
  br i1 %5, label %omp_if.then, label %omp_if.end, !dbg !51

omp_if.then:                                      ; preds = %entry
  store i32 10, i32* %0, align 4, !dbg !53, !tbaa !21
  call void @__kmpc_end_single(%struct.ident_t* @1, i32 %3), !dbg !56
  br label %omp_if.end, !dbg !56

omp_if.end:                                       ; preds = %omp_if.then, %entry
  call void @__kmpc_barrier(%struct.ident_t* @2, i32 %3), !dbg !57
  %6 = load i32, i32* %0, align 4, !dbg !58, !tbaa !21
  store i32 %6, i32* %local, align 4, !dbg !59, !tbaa !21
  %7 = bitcast i32* %local to i8*, !dbg !60
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %7) #4, !dbg !60
  ret void, !dbg !61
}
...
; Function Attrs: norecurse nounwind sspstrong uwtable
define internal void @.omp_outlined.(i32* noalias %.global_tid., i32* noalias %.bound_tid., i32* nonnull align 4 dereferenceable(4) %init) #3 !dbg !62 {
entry:
  %.global_tid..addr = alloca i32*, align 8
  %.bound_tid..addr = alloca i32*, align 8
  %init.addr = alloca i32*, align 8
  ...
  %0 = load i32*, i32** %init.addr, align 8, !dbg !68, !tbaa !26
  %1 = load i32*, i32** %.global_tid..addr, align 8, !dbg !68, !tbaa !26
  %2 = load i32*, i32** %.bound_tid..addr, align 8, !dbg !68, !tbaa !26
  %3 = load i32*, i32** %init.addr, align 8, !dbg !68, !tbaa !26
  call void @.omp_outlined._debug__(i32* %1, i32* %2, i32* %3) #4, !dbg !68
  ret void, !dbg !68
}

; Function Attrs: nounwind
declare !callback !69 void @__kmpc_fork_call(%struct.ident_t*, i32, void (i32*, i32*, ...)*, ...) #4
...
!1 = !DIFile(filename: "DRB125-single-orig-no.c", directory: "/home/peiming/Documents/projects/OpenRace/tests/data/integration/dataracebench")
!2 = !{}
...
!34 = !DILocation(line: 38, column: 3, scope: !9)
...
!62 = distinct !DISubprogram(name: ".omp_outlined.", scope: !1, file: !1, line: 29, type: !36, scopeLine: 29, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !63)
!63 = !{!64, !65, !66}
...
!68 = !DILocation(line: 29, column: 3, scope: !62)
!69 = !{!70}
