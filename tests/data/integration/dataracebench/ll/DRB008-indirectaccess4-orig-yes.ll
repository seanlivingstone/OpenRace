; ModuleID = 'DRB008-indirectaccess4-orig-yes.c'
source_filename = "DRB008-indirectaccess4-orig-yes.c"
...
@0 = private unnamed_addr constant [48 x i8] c";DRB008-indirectaccess4-orig-yes.c;main;124;1;;\00", align 1
...
@2 = private unnamed_addr constant [49 x i8] c";DRB008-indirectaccess4-orig-yes.c;main;124;86;;\00", align 1
...
entry:
  ...
  call void @__kmpc_for_static_init_4(%struct.ident_t* @1, i32 %9, i32 34, i32* %.omp.is_last, i32* %.omp.lb, i32* %.omp.ub, i32* %.omp.stride, i32 1, i32 1), !dbg !115
...
omp.inner.for.cond:                               ; preds = %omp.inner.for.inc, %cond.end
  ...
  br i1 %cmp1, label %omp.inner.for.body, label %omp.inner.for.cond.cleanup, !dbg !113
...
omp.inner.for.body:                               ; preds = %omp.inner.for.cond
  ...
  %mul = mul nsw i32 %15, 1, !dbg !116
  %add = add nsw i32 0, %mul, !dbg !116
  store i32 %add, i32* %i, align 4, !dbg !116, !tbaa !32
  %16 = bitcast i32* %idx to i8*, !dbg !117
  call void @llvm.lifetime.start.p0i8(i64 4, i8* %16) #6, !dbg !117
  call void @llvm.dbg.declare(metadata i32* %idx, metadata !108, metadata !DIExpression()), !dbg !118
  %17 = load i32, i32* %i, align 4, !dbg !119, !tbaa !32
  %idxprom = sext i32 %17 to i64, !dbg !120
  %arrayidx = getelementptr inbounds [180 x i32], [180 x i32]* @indexSet, i64 0, i64 %idxprom, !dbg !120
  %18 = load i32, i32* %arrayidx, align 4, !dbg !120, !tbaa !32
  store i32 %18, i32* %idx, align 4, !dbg !118, !tbaa !32
  %19 = load double*, double** %0, align 8, !dbg !121, !tbaa !37
  %20 = load i32, i32* %idx, align 4, !dbg !122, !tbaa !32
  %idxprom2 = sext i32 %20 to i64, !dbg !121
  %arrayidx3 = getelementptr inbounds double, double* %19, i64 %idxprom2, !dbg !121
  %21 = load double, double* %arrayidx3, align 8, !dbg !123, !tbaa !73
  %add4 = fadd double %21, 1.000000e+00, !dbg !123
  store double %add4, double* %arrayidx3, align 8, !dbg !123, !tbaa !73
  %22 = load double*, double** %1, align 8, !dbg !124, !tbaa !37
  %23 = load i32, i32* %idx, align 4, !dbg !125, !tbaa !32
  %idxprom5 = sext i32 %23 to i64, !dbg !124
  %arrayidx6 = getelementptr inbounds double, double* %22, i64 %idxprom5, !dbg !124
  %24 = load double, double* %arrayidx6, align 8, !dbg !126, !tbaa !73
  %add7 = fadd double %24, 3.000000e+00, !dbg !126
  store double %add7, double* %arrayidx6, align 8, !dbg !126, !tbaa !73
  %25 = bitcast i32* %idx to i8*, !dbg !127
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %25) #6, !dbg !127
...
omp.inner.for.inc:                                ; preds = %omp.body.continue
  %26 = load i32, i32* %.omp.iv, align 4, !dbg !114, !tbaa !32
  %add8 = add nsw i32 %26, 1, !dbg !113
  store i32 %add8, i32* %.omp.iv, align 4, !dbg !113, !tbaa !32
  br label %omp.inner.for.cond, !dbg !115, !llvm.loop !129

omp.inner.for.end:                                ; preds = %omp.inner.for.cond.cleanup
  br label %omp.loop.exit, !dbg !115

omp.loop.exit:                                    ; preds = %omp.inner.for.end
  call void @__kmpc_for_static_fini(%struct.ident_t* @3, i32 %9), !dbg !130
  %27 = bitcast i32* %i to i8*, !dbg !115
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %27) #6, !dbg !115
  %28 = bitcast i32* %.omp.is_last to i8*, !dbg !115
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %28) #6, !dbg !115
  %29 = bitcast i32* %.omp.stride to i8*, !dbg !115
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %29) #6, !dbg !115
  %30 = bitcast i32* %.omp.ub to i8*, !dbg !115
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %30) #6, !dbg !115
  %31 = bitcast i32* %.omp.lb to i8*, !dbg !115
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %31) #6, !dbg !115
  %32 = bitcast i32* %.omp.iv to i8*, !dbg !115
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %32) #6, !dbg !115
  ret void, !dbg !127
}
...
; Function Attrs: norecurse nounwind sspstrong uwtable
define internal void @.omp_outlined.(i32* noalias %.global_tid., i32* noalias %.bound_tid., double** nonnull align 8 dereferenceable(8) %xa1, double** nonnull align 8 dereferenceable(8) %xa2) #5 !dbg !131 {
entry:
  %.global_tid..addr = alloca i32*, align 8
  %.bound_tid..addr = alloca i32*, align 8
  %xa1.addr = alloca double**, align 8
  %xa2.addr = alloca double**, align 8
  store i32* %.global_tid., i32** %.global_tid..addr, align 8, !tbaa !37
  call void @llvm.dbg.declare(metadata i32** %.global_tid..addr, metadata !133, metadata !DIExpression()), !dbg !137
  store i32* %.bound_tid., i32** %.bound_tid..addr, align 8, !tbaa !37
  call void @llvm.dbg.declare(metadata i32** %.bound_tid..addr, metadata !134, metadata !DIExpression()), !dbg !137
  store double** %xa1, double*** %xa1.addr, align 8, !tbaa !37
  call void @llvm.dbg.declare(metadata double*** %xa1.addr, metadata !135, metadata !DIExpression()), !dbg !137
  store double** %xa2, double*** %xa2.addr, align 8, !tbaa !37
  call void @llvm.dbg.declare(metadata double*** %xa2.addr, metadata !136, metadata !DIExpression()), !dbg !137
  %0 = load double**, double*** %xa1.addr, align 8, !dbg !138, !tbaa !37
  %1 = load double**, double*** %xa2.addr, align 8, !dbg !138, !tbaa !37
  %2 = load i32*, i32** %.global_tid..addr, align 8, !dbg !138, !tbaa !37
  %3 = load i32*, i32** %.bound_tid..addr, align 8, !dbg !138, !tbaa !37
  %4 = load double**, double*** %xa1.addr, align 8, !dbg !138, !tbaa !37
  %5 = load double**, double*** %xa2.addr, align 8, !dbg !138, !tbaa !37
  call void @.omp_outlined._debug__(i32* %2, i32* %3, double** %4, double** %5) #6, !dbg !138
  ret void, !dbg !138
}

; Function Attrs: nounwind
declare !callback !139 void @__kmpc_fork_call(%struct.ident_t*, i32, void (i32*, i32*, ...)*, ...) #6

; Function Attrs: nounwind
declare !dbg !141 void @free(i8*) #3
...
!1 = distinct !DIGlobalVariable(name: "indexSet", scope: !2, file: !3, line: 69, type: !9, isLocal: false, isDefinition: true)
...
!3 = !DIFile(filename: "DRB008-indirectaccess4-orig-yes.c", directory: "/home/peiming/Documents/projects/OpenRace/tests/data/integration/dataracebench")
!4 = !{}
!5 = !{!6}
...
!19 = distinct !DISubprogram(name: "main", scope: !3, file: !3, line: 106, type: !20, scopeLine: 107, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !2, retainedNodes: !25)
...
!26 = !DILocalVariable(name: "argc", arg: 1, scope: !19, file: !3, line: 106, type: !10)
!27 = !DILocalVariable(name: "argv", arg: 2, scope: !19, file: !3, line: 106, type: !22)
!28 = !DILocalVariable(name: "base", scope: !19, file: !3, line: 108, type: !6)
...
!35 = !{!"Simple C/C++ TBAA"}
!36 = !DILocation(line: 106, column: 15, scope: !19)
!37 = !{!38, !38, i64 0}
!38 = !{!"any pointer", !34, i64 0}
!39 = !DILocation(line: 106, column: 27, scope: !19)
!40 = !DILocation(line: 108, column: 3, scope: !19)
!41 = !DILocation(line: 108, column: 12, scope: !19)
!42 = !DILocation(line: 108, column: 29, scope: !19)
!43 = !DILocation(line: 108, column: 19, scope: !19)
!44 = !DILocation(line: 109, column: 7, scope: !45)
!45 = distinct !DILexicalBlock(scope: !19, file: !3, line: 109, column: 7)
!46 = !DILocation(line: 109, column: 12, scope: !45)
!47 = !DILocation(line: 109, column: 7, scope: !19)
!48 = !DILocation(line: 111, column: 5, scope: !49)
!49 = distinct !DILexicalBlock(scope: !45, file: !3, line: 110, column: 3)
...
!82 = !DILocation(line: 131, column: 39, scope: !19)
!83 = !DILocation(line: 131, column: 49, scope: !19)
!84 = !DILocation(line: 131, column: 3, scope: !19)
!85 = !DILocation(line: 132, column: 9, scope: !19)
!86 = !DILocation(line: 132, column: 3, scope: !19)
!87 = !DILocation(line: 133, column: 3, scope: !19)
!88 = !DILocation(line: 134, column: 1, scope: !19)
...
!121 = !DILocation(line: 128, column: 5, scope: !109)
!122 = !DILocation(line: 128, column: 9, scope: !109)
!123 = !DILocation(line: 128, column: 13, scope: !109)
!124 = !DILocation(line: 129, column: 5, scope: !109)
!125 = !DILocation(line: 129, column: 9, scope: !109)
!126 = !DILocation(line: 129, column: 13, scope: !109)
!127 = !DILocation(line: 130, column: 3, scope: !89)
!128 = !DILocation(line: 130, column: 3, scope: !109)
!129 = distinct !{!129, !115, !130}
!130 = !DILocation(line: 124, column: 86, scope: !89)
!131 = distinct !DISubprogram(name: ".omp_outlined.", scope: !3, file: !3, line: 124, type: !90, scopeLine: 124, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !2, retainedNodes: !132)
!132 = !{!133, !134, !135, !136}
!133 = !DILocalVariable(name: ".global_tid.", arg: 1, scope: !131, type: !92, flags: DIFlagArtificial)
!134 = !DILocalVariable(name: ".bound_tid.", arg: 2, scope: !131, type: !92, flags: DIFlagArtificial)
!135 = !DILocalVariable(name: "xa1", arg: 3, scope: !131, type: !96, flags: DIFlagArtificial)
!136 = !DILocalVariable(name: "xa2", arg: 4, scope: !131, type: !96, flags: DIFlagArtificial)
!137 = !DILocation(line: 0, scope: !131)
!138 = !DILocation(line: 124, column: 1, scope: !131)
!139 = !{!140}
!140 = !{i64 2, i64 -1, i64 -1, i1 true}
!141 = !DISubprogram(name: "free", scope: !142, file: !142, line: 565, type: !143, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized, retainedNodes: !4)
